/* Shared cover-image generator (SERVER version → ESM export).
   ⚠️ Keep in sync with public/cover.js (identical logic). Used to inline the
   cover SVG into server-rendered worksheet detail pages (SEO + no-JS). */
